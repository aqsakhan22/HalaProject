                ...
                <div   style={{border:"1px solid lightgray"} } class="row" >
					...
					{/* <h2 class="font-weight-bold" style={{color:"purple"}}>Overview</h2> */}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p id="subdata">www.identiti.sa</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p id="subdata">Computer Software</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p id="subdata">Riyadh, Saudi Arabia</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
					...
					{/* <h2 class="font-weight-bold" style={{color:"purple"}}>Overview</h2> */}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p id="subdata">Talents Acquisition Manager</p>
                                            </div>
                                        </div>
